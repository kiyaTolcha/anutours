import { MapPin, Clock, Users, Star, Zap, Shield, Target, Heart } from 'lucide-react'
  ...
  const adventures = [
    {
      ...
      reviews: 234,
      difficulty: "Extreme",
      description: "Push your limits with rock climbing, bungee jumping, and extreme sports.",
      highlights: ["Rock Climbing", "Bungee Jumping", "Skydiving", "Safety Training"]
    },
    {
      id: 2,
      ...
      reviews: 189,
      difficulty: "Moderate",
      description: "Experience thrilling water sports and aquatic adventures.",
      highlights: ["White Water Rafting", "Kayaking", "Surfing", "Snorkeling"]
    },
    {
      id: 3,
      ...
      description: "Navigate vast desert landscapes and experience nomadic life.",
    ...
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Professional guides and top-quality safety equipment</p>
            </div>
            <div className="text-center">
              ...
              <div key={adventure.id} className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="text-2xl font-bold text-red-600">From {adventure.price}</div>
                    <Link href={`/activities/adventure/${adventure.id}`} className="bg-red-600 text-white px-6 py-2 rounded-lg hover:bg-red-700 transition-colors font-medium">
                      Book Adventure
                    </Link>
                  </div>
                </div>
      ...
      <section className="py-16 bg-red-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-red-100 mb-8 max-w-3xl mx-auto">Push your boundaries and create unforgettable memories with our extreme adventure tours</p>
          <Link href="/contact" className="bg-white text-red-600 px-8 py-3 rounded-lg hover:bg-gray-100 transition-colors font-semibold text-lg">
            Book Your Adventure
          </Link>
        </div>
      </section>
