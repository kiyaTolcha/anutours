...
export default function PopularTours() {
  const tours = [
    ...
    },
    {
      ...
      reviews: 203,
      location: "Lalibela",
      description: "Discover the 11 medieval rock-hewn churches, a UNESCO World Heritage site and one of Ethiopia's most sacred places."
    },
    {
      id: 3,
      ...
      description: "Experience the hottest place on earth with active volcanoes, salt lakes, and otherworldly landscapes."
    },
    {
      id: 4,
      title: "Northern Ethiopia Historic Route",
      ...
      rating: 4.7,
      reviews: 142,
      location: "Bahir Dar, Gondar, Lalibela",
      description: "Follow the ancient historic route through Ethiopia's most significant historical sites and royal capitals."
    },
    {
      id: 5,
